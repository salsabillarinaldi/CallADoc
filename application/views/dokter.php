      ...
      <table class="table table-bordered" id="table">
        ...
        <!--HINT UNTUK MENGHAPUS USER KALIAN DAPAT MENGGUNAKAN FORM, MENGGUNAKAN ANCHOR ATAU HREF PADA BUTTON-->
            <form action="">
              ...
              <!--BUTTON EDIT Dokter-->
              <td><button type="button" class="btn btn-warning btn-lg" data-toggle="modal" data-target="#edit<?php echo $d->nid ?>"><i class="fas fa-envelope"></i></button></td>
  ...
  <div class="modal fade" id="edit<?php echo $d->nid ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <!-- isi form ini -->
        <form method="post" action="<?php echo base_url('web/editdokter/'); ?>">
         <div class="form-group">
                <label for="formGroupExampleInput">Email To:</label>
                <input type="text" class="form-control" name="emailto" placeholder="<?php echo $d->nama ?>" value="" disabled>
          </div>
          <div class="form-group">
            <label for="formGroupExampleInput">Subject</label>
            <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Subject" name="nama" required>
          </div>
          <div>
