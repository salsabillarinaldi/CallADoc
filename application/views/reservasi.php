...
<table class="table table-bordered" id="table">
        ...
        <?php $no=1; foreach ($data as $d ) {?>
            <tr>
                <form action="">
                    ...
                    <td>
                         <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#pesan<?php echo $d->nid ?>">Balas</button>
 ...
 <?php $no=1; foreach ($data as $d ) {?>
        <div class="modal fade" id="pesan<?php echo $d->nid ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <form method="post" action="<?php echo base_url('page/kirimpesan/'.$d->nid); ?>">
                                <input type="text" class="form-control" id="formGroupExampleInput" placeholder="" name="idpengirim" value="<?php echo $d->idpengirim?>" readonly>
                  ...
                  "></textarea>
                                ...
                                <input id="datepicker" width="270" name="tanggal" value="<?php echo $d->tanggal?>" />
                                <div class="form-group">
                                    <label for="sel1">Jam:</label>
                                    <select class="form-control" id="jam" name="jam" value="<?php echo $d->jam?>">
                                        <option>14.00</option>
                                        <option>15.00</option>
                                        <option>16.00</option>
                                        <option>20.00</option>
