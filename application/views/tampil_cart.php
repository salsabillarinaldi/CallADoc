...
<form action="<?php echo base_url()?>page/ubah_cart" method="post" name="frmweb" id="frmweb" class="form-horizontal" enctype="multipart/form-data">
<?php
...
<a href="<?php echo base_url()?>page/check_out"  class ='btn btn-sm btn-primary'>Check Out</a>
</tr>
