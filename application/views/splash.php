                                ...
                                <div class="title-01 title-01--11 text-center">
                                    <h2 class="title__heading">
                                        ...
                                        <strong class="hero-section__words">
                                            <span class="title__effect is-visible">Healthy?</span>
                                            <span class="title__effect">Fit?</span>
                                            <span class="title__effect">well?</span>
                                        </strong>
                                    </h2>
                                    <div class="title__description">Caring your health with Call a Doc! <br />
                                    The solution for your healthy care</div>
