        ...
        <div class="row">
            <div class="col-md-7 col-sm-6">
                <div class="about-title clearfix">
                    <h1>About <span>Call A Doc</span></h1>
                    <h3>The solution for your healthy care</h3>
                    <p class="about-paddingB"></p>
                    <p>Call A Doc is made to facilitate customers <br />who want to consult to Doctor or buy a medicine easily from home.</p>
                    <div class="about-icons">
                        <ul>
                            ...
                            <li> <a href="mailto:admin@takecare.com"><i id="social-em" class="fa fa-envelope-square fa-3x social"></i></a> </li>
                        </ul>
