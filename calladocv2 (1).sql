...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 24, 2020 at 09:30 PM
...
CREATE TABLE `pesan` (
  `nopesan` int(255) NOT NULL,
  `nama` varchar(255) NOT NULL,
  `subjek` varchar(255) NOT NULL,
  `pesan` varchar(255) NOT NULL,
  `tanggal` varchar(255) NOT NULL,
  `jam` varchar(255) NOT NULL,
  `idpengirim` int(255) NOT NULL,
...
INSERT INTO `pesan` (`nopesan`, `nama`, `subjek`, `pesan`, `tanggal`, `jam`, `idpengirim`, `untuk`) VALUES
(1, 'Dr. Salsabilla Rinaldii', 'Appointment', 'iya deal', '04/08/2020', '14.00', 0, 'Maiza Radhiya'),
(2, 'Dr. Salsabilla Rinaldii', 'Appointment', 'iya deal', '04/08/2020', '14.00', 0, 'Maiza Radhiya'),
(3, 'Dr. Salsabilla Rinaldii', 'Appointment', 'd', '04/08/2020', '14.00', 0, 'Maiza Radhiya'),
(4, 'Dr. Salsabilla Rinaldii', 'Appointment', 'tes', '04/08/2020', '14.00', 0, 'Maiza Radhiya'),
(5, 'Dr. Salsabilla Rinaldii', 'Appointment', 'tes', '04/08/2020', '14.00', 0, 'Maiza Radhiya'),
(6, 'Dr. Salsabilla Rinaldii', 'Appointment', 'iya bisa', '04/08/2020', '14.00', 0, 'Maiza Radhiya'),
(10, 'Dr. Salsabilla Rinaldi', 'Appointment', 'apaa coy', '04/22/2020', '14.00', 3, 'Maiza Radhiya');
...
INSERT INTO `reservasi` (`noreservasi`, `nid`, `nama`, `subjek`, `pengirim`, `pesan`, `tanggal`, `jam`, `idpengirim`) VALUES
(18, '1301180029', 'Dr. Salsabilla Rinaldi', 'Appointment', 'Maiza Radhiya', 'Besok bisa kan dok\r\nWA:+62 8123123', '04/20/2020', '14.00', 0),
(20, '1301180029', 'Dr. Salsabilla Rinaldi', 'Appointment', 'Lintang Aryasatya', 'Besok ya kak', '04/20/2020', '14.00', 0),
(22, '1', 'Dr. Salsabilla Rinaldi', 'Appointment', 'Maiza Radhiya', 'qwe', '04/22/2020', '14.00', 3),
(23, '1', 'Dr. Salsabilla Rinaldii', 'Appointment', 'Maiza Radhiya', 'Woi', '04/26/2020', '14.00', 3);
...
--
ALTER TABLE `pesan`
  MODIFY `nopesan` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
